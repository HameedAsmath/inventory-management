...
function getShop(shop) {
    return {
        name: (shop === null || shop === void 0 ? void 0 : shop.name) || process.env.SHOP_NAME || "My Shop",
        address: (shop === null || shop === void 0 ? void 0 : shop.address) || process.env.SHOP_ADDRESS || "",
        pincode: (shop === null || shop === void 0 ? void 0 : shop.pincode) || process.env.SHOP_PINCODE || "",
        contact: (shop === null || shop === void 0 ? void 0 : shop.contact) || process.env.SHOP_CONTACT || "",
        gst: (shop === null || shop === void 0 ? void 0 : shop.gst) || process.env.SHOP_GST || "",
    };
}
const C = {
    brand: "#1e40af",
...
function tw(doc, text, x, y, width, align = "left") {
    doc.text(text, x, y, { width, align, lineBreak: false });
}
function line(doc, y, x1, x2, color = C.border) {
    doc
        .save()
        .strokeColor(color)
        .lineWidth(0.5)
...
const statusLabel = (s) => s === "success" ? "Paid" : s === "cancelled" ? "Cancelled" : "Pending";
const statusColor = (s) => s === "success" ? "#059669" : s === "cancelled" ? "#dc2626" : "#d97706";
export function generateStatementPdf(data, shop) {
    return new Promise((resolve, reject) => {
        ...
        const footerH = 50;
        const gaps = 80;
        const contentH = headerH + customerH + tableHeaderH + itemsH + totalsH + footerH + gaps;
        ...
        tw(doc, `Generated: ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })}`, m, 85, cw, "right");
        y += 6;
        line(doc, y, m, pw - m);
        y += 12;
        // ===== TABLE =====
        ...
        data.bills.forEach((bill, i) => {
            ...
            tw(doc, d.toLocaleDateString("en-US", {
                month: "short",
                day: "numeric",
                year: "2-digit",
            }), cols.date, y + 5, dateW, "center");
            doc
                .font("Helvetica-Bold")
                .fontSize(7.5)
                .fillColor(statusColor(bill.paymentStatus));
            tw(doc, statusLabel(bill.paymentStatus).toUpperCase(), cols.status, y + 5, statusW, "center");
            doc.fontSize(8.5);
            doc.font("Helvetica").fillColor(C.med);
